...
let _orderTransporter = null;
const getOrderTransporter = () => {
  if (_orderTransporter) return _orderTransporter;
  _orderTransporter = makeTransporter(
    process.env.ORDER_SMTP_USER,
    process.env.ORDER_SMTP_PASS,
  );
  return _orderTransporter;
};

let _supportTransporter = null;
const getSupportTransporter = () => {
  if (_supportTransporter) return _supportTransporter;
  _supportTransporter = makeTransporter(
    process.env.SUPPORT_SMTP_USER,
    process.env.SUPPORT_SMTP_PASS,
  );
  return _supportTransporter;
};
