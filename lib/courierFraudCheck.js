 ...
 * (Pathao, Steadfast, RedX). Not limited to Pickob orders.
...
export async function fetchLifetimeCourierStats(
  ...
  const result = {
    ...
    description:
      "Lifetime parcel history for this mobile on Pathao, Steadfast, and RedX networks (all shops, not only Pickob).",
    configured,
    anyConfigured,
    couriers,
